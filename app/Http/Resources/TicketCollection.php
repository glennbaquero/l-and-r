    ...
    public function toArray($request)
    {
        return $this->collection->map(function($ticket) {
            ...
            if(!auth()->guard('web_user')->check()) {
                if(!empty($ticket->seller_id)) {
                    $office_name = $ticket->office ? $ticket->office->name : $ticket->seller->office->name;
                }
            }
            ...
            return [
                ...
                'passenger_count' => $ticket->number_of_ticket ?? 1,
                ...
                'webPrintUrl' => route('web.ticket.print', [$ticket->ticket_number, $ticket->passenger->fullname, $ticket->arrival->name, $ticket->departure->name]),
